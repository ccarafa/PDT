...
urlpatterns = [
    ...
    url(r'^projectpage/projectbuttons/phase/phasespage/$', 'login.views.phasespage'),
    url(r'^activities/$', 'login.views.activityDashboard'),
    url(r'^activities/activity$', 'login.views.activity'),
