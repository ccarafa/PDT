...
def phase(request):
	...
	for instance in Phase.objects.all():
		#print("###instance project name: "+instance.project_name+" session project name: "+request.session['project_name']+" instance phase name: "+instance.phase_name+" session phase name :"+request.session['phase_name'])
